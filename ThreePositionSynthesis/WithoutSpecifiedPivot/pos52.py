# Position analysis of the four-bar synthesized by syn52 (Ex. 5.2)
...
c = 3.200
d = 9.030
T_VZ = 61.569 # angle (deg) between V(coupler) and Z
T_1H = 63.914 # angle (deg) between link1 and horizontal # this is for making link1 horizontal.
